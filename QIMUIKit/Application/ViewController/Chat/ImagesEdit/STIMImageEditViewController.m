...
@interface STIMImageEditViewController ()
{
    ...
    STIMImageClipView   * _imageClipView;//图片裁剪
    
    STIMImageDoodleView * _imageDoodleView;//涂鸦
...
@implementation STIMImageEditViewController
...
{
    if (self.fromAlum) {
        _naviBar = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetHeight([UIScreen mainScreen].bounds) - [[STIMDeviceManager sharedInstance] getHOME_INDICATOR_HEIGHT] - 44, CGRectGetWidth([UIScreen mainScreen].bounds), 44)];
    } else {
        _naviBar = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.height - [[STIMDeviceManager sharedInstance] getHOME_INDICATOR_HEIGHT] - 44, CGRectGetWidth([UIScreen mainScreen].bounds), 44)];
    }
    _naviBar.backgroundColor = [UIColor stimDB_colorWithHex:0x414141 alpha:1.0];
    [self.view addSubview:_naviBar];
    
    UIButton * cancelBtn = [UIButton buttonWithType:UIButtonTypeSystem];
    cancelBtn.frame = CGRectMake(0, 12, 50, 20);
    [cancelBtn setTitle:[NSBundle stimDB_localizedStringForKey:@"common_cancel"] forState:UIControlStateNormal];
    ...
    [_duangBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_photo_filter"] forState:UIControlStateNormal];
    [_duangBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_photo_filter_pressed"] forState:UIControlStateHighlighted];
    [_duangBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_photo_filter_pressed"] forState:UIControlStateSelected];
    ...
    [_clipsBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_photo_cut"] forState:UIControlStateNormal];
    [_clipsBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_photo_cut_pressed"] forState:UIControlStateHighlighted];
    [_clipsBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_photo_cut_pressed"] forState:UIControlStateSelected];
    ...
    [_doodleBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_photo_brush"] forState:UIControlStateNormal];
    [_doodleBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_photo_brush_pressed"] forState:UIControlStateHighlighted];
    [_doodleBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_photo_brush_pressed"] forState:UIControlStateSelected];
    ...
    [sendBtn setTitle:[NSBundle stimDB_localizedStringForKey:@"common_ok"] forState:UIControlStateNormal];
...
- (void)addDuangView
{
    ...
    _titles = [[NSArray alloc] initWithObjects:[NSBundle stimDB_localizedStringForKey:@"Full Image"],@"LOMO",@"黑白",@"怀旧",@"哥特",@"锐化",@"淡雅",@"酒红",@"清宁",@"浪漫",@"光晕",@"蓝调",@"梦幻",@"夜色", nil];
    ...
    _duangView.backgroundColor = [UIColor stimDB_colorWithHex:0x2e2e2e alpha:1.0];
    ...
    for (NSString * imageStr in _dataSource) {
        ...
        imageView.image = [self getDuangImageWithIndexTag:i originalImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:imageStr]];
...
- (void)addOrientationView
{
    ...
    _orientationView.backgroundColor = [UIColor stimDB_colorWithHex:0x2e2e2e alpha:1.0];
...
//    [orientationLeftBtn setTitle:@"left" forState:UIControlStateNormal];
    [orientationLeftBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"pe_crop_left_ccw_normal"] forState:UIControlStateNormal];
    [orientationLeftBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"pe_crop_left_ccw_pressed"] forState:UIControlStateHighlighted];
...
//    [orientationRightBtn setTitle:@"right" forState:UIControlStateNormal];
    [orientationRightBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"pe_crop_right_ccw_normal"] forState:UIControlStateNormal];
    [orientationRightBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"pe_crop_right_ccw_pressed"] forState:UIControlStateHighlighted];
...
- (void)addDoodleSelectBar
{
    ...
    _doodleSelectBar.backgroundColor = [UIColor stimDB_colorWithHex:0x2e2e2e alpha:1.0];
    ...
    [cleanBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"pe_doodle_eraser_normal"] forState:UIControlStateNormal];
    [cleanBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"pe_doodle_eraser_pressed"] forState:UIControlStateHighlighted];
    [cleanBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"pe_doodle_eraser_pressed"] forState:UIControlStateSelected];
...
- (void)setUpSTIMImageClipView
{
    if (_imageClipView) {
        [_imageClipView resetClipRectWithImage:_imageDisplayView.image];
        [self.view bringSubviewToFront:_imageClipView];
    }else{
        _imageClipView = [[STIMImageClipView alloc] initWithFrame:kClipImageViewFrame imageView:_imageDisplayView.image];
...
{
    _imageDoodleView = [[STIMImageDoodleView alloc] initWithFrame:CGRectZero];
...
{
    if ([[btn titleForState:UIControlStateNormal] isEqualToString:[NSBundle stimDB_localizedStringForKey:@"common_ok"]]) {
        [self saveDoodleImage];
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:[NSBundle stimDB_localizedStringForKey:@"common_prompt"]
                                                        message:@"图片尚未保存，是否保存图片？"
                                                       delegate:self
                                              cancelButtonTitle:[NSBundle stimDB_localizedStringForKey:@"send_directly"]
...
- (void)image: (UIImage *) image didFinishSavingWithError: (NSError *) error contextInfo: (void *) contextInfo
{
    ...
    if(error != NULL){
        msg = [NSBundle stimDB_localizedStringForKey:@"save_faild"] ;
        alert = [[UIAlertView alloc] initWithTitle:[NSBundle stimDB_localizedStringForKey:@"common_prompt"]
                                   message:msg
                                  delegate:self
                         cancelButtonTitle:[NSBundle stimDB_localizedStringForKey:@"common_ok"]
...
- (void)orientationBtnHandle:(UIButton *)btn
{
    ...
    if (btn.tag == kTurnLeftBtnTag) {
        _imageDisplayView.image = [STIMImageUtil image:_imageDisplayView.image rotation:UIImageOrientationLeft];
        _tempOriginalImage = [STIMImageUtil image:_tempOriginalImage rotation:UIImageOrientationLeft];
        
    }else if (btn.tag == kTurnRightBtnTag){
        _imageDisplayView.image = [STIMImageUtil image:_imageDisplayView.image rotation:UIImageOrientationRight];
        _tempOriginalImage = [STIMImageUtil image:_tempOriginalImage rotation:UIImageOrientationRight];
    }
    [_imageClipView resetClipRectWithImage:_imageDisplayView.image];
}
...
- (UIImage *)getDuangImageWithIndexTag : (NSInteger)indexTag originalImage : (UIImage *)originalImage
{
    ...
    switch (indexTag) {
        ...
        case 1:
        {
            image = [STIMImageUtil imageWithImage:originalImage withColorMatrix:colormatrix_lomo];
        }
            break;
        case 2:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:colormatrix_heibai];
        }
            break;
        case 3:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:colormatrix_huajiu];
        }
            break;
        case 4:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:colormatrix_gete];
        }
            break;
        case 5:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:colormatrix_ruise];
        }
            break;
        case 6:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:colormatrix_danya];
        }
            break;
        case 7:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:colormatrix_jiuhong];
        }
            break;
        case 8:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:colormatrix_qingning];
        }
            break;
        case 9:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:colormatrix_langman];
        }
            break;
        case 10:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:colormatrix_guangyun];
        }
            break;
        case 11:
        {
            image = [STIMImageUtil imageWithImage:originalImage withColorMatrix:colormatrix_landiao];
            
        }
            break;
        case 12:
        {
            image = [STIMImageUtil imageWithImage:originalImage withColorMatrix:colormatrix_menghuan];
            
        }
            break;
        case 13:
        {
            image = [STIMImageUtil imageWithImage:originalImage withColorMatrix:colormatrix_yese];
...
- (void)saveDoodleImage
{
    ...
    _productImage = [STIMImageUtil addImage:doodleImage toImage:_productImage subRect:CGRectMake(0, 0, doodleImage.size.width * scale, doodleImage.size.height * scale)];
    _imageDisplayView.image = _productImage;
    _originalImage = [STIMImageUtil addImage:doodleImage toImage:_originalImage subRect:CGRectMake(0, 0, doodleImage.size.width * scale, doodleImage.size.height * scale)];
}

...
@implementation STIMFriendSettingItem

@end

@implementation STIMFriendSettingCell{ 
    UILabel *_titleLabel;
    UILabel *_descLabel;
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, ([STIMFriendSettingCell getCellHeight] - 40)/2.0, self.width - 125 - 20, 40)];
        ...
        _descLabel =  [[UILabel alloc] initWithFrame:CGRectMake(self.width - 125, ([STIMFriendSettingCell getCellHeight] - 20)/2.0, 100, 20)];
        ...
        _selectedImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, ([STIMFriendSettingCell getCellHeight] - 20)/2.0, 20, 20)];
        [_selectedImageView setAutoresizingMask:UIViewAutoresizingFlexibleLeftMargin];
        [_selectedImageView setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"chat_group_selected"]];
...
- (void)refreshUI{
    ...
    _titleLabel.frame = CGRectMake(10, ([STIMFriendSettingCell getCellHeight] - 40)/2.0, self.width - 125 - 20, 40);
    _descLabel.frame = CGRectMake(self.width - 125, ([STIMFriendSettingCell getCellHeight] - 20)/2.0, 100, 20);
    
    _titleLabel.font = [UIFont fontWithName:FONT_NAME size:[[STIMCommonFont sharedInstance] currentFontSize] - 2];
    _descLabel.font = [UIFont fontWithName:FONT_NAME size:[[STIMCommonFont sharedInstance] currentFontSize] - 4];

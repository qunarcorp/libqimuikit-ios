...
@interface STIMNacConfigTableViewCell ()
...
@implementation STIMNacConfigTableViewCell
...
- (UIView *)navBgView {
    if (!_navBgView) {
        ...
        _navBgView.backgroundColor = [UIColor stimDB_colorWithHex:0xF3F3F3];
    }
    return _navBgView;
}
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = [UIColor stimDB_colorWithHex:0x9B9B9B];
    }
    return _titleLabel;
}
...
- (UILabel *)navLabel {
    if (!_navLabel) {
        ...
        _navLabel.textColor = [UIColor stimDB_colorWithHex:0x9B9B9B];
    }
    return _navLabel;
}
...
- (UIButton *)checkButton {
    if (!_checkButton) {
        ...
        [_checkButton setImage:[UIImage qimIconWithInfo:[STIMIconInfo iconInfoWithText:@"\U0000e337" size:28 color:[UIColor stimDB_colorWithHex:0xE4E4E4]]] forState:UIControlStateNormal];
        [_checkButton setImage:[UIImage qimIconWithInfo:[STIMIconInfo iconInfoWithText:@"\U0000e337" size:28 color:[UIColor stimDB_colorWithHex:0x00CABE]]] forState:UIControlStateSelected];
...
- (UIButton *)qrcodeBtn {
    if (!_qrcodeBtn) {
        ...
        [_qrcodeBtn setImage:[UIImage qimIconWithInfo:[STIMIconInfo iconInfoWithText:@"\U0000f10d" size:20 color:[UIColor colorWithRed:97/255.0 green:97/255.0 blue:97/255.0 alpha:1/1.0]]] forState:UIControlStateNormal];
...
- (UIButton *)modifyBtn {
    if (!_modifyBtn) {
        ...
        [_modifyBtn setTitle:[NSBundle stimDB_localizedStringForKey:@"nav_change_Navigation"] forState:UIControlStateNormal];
        ...
        _modifyBtn.layer.borderColor = [UIColor stimDB_colorWithHex:0xD9D9D9].CGColor;
...
- (UIButton *)deleteBtn {
    if (!_deleteBtn) {
        ...
        [_deleteBtn setTitle:[NSBundle stimDB_localizedStringForKey:@"nav_delete_Navigation"] forState:UIControlStateNormal];
        ...
        _deleteBtn.layer.borderColor = [UIColor stimDB_colorWithHex:0xD9D9D9].CGColor;
...
- (void)setUpUINormal {
    [self.navBgView setBackgroundColor:[UIColor stimDB_colorWithHex:0xF3F3F3]];
    [self.titleLabel setTextColor:[UIColor stimDB_colorWithHex:0x9B9B9B]];
    [self.navLabel setTextColor:[UIColor stimDB_colorWithHex:0x9B9B9B]];
    [self.qrcodeBtn setSelected:YES];
    [self.checkButton setSelected:NO];
    self.modifyBtn.layer.borderColor = [UIColor stimDB_colorWithHex:0xD9D9D9].CGColor;
    self.deleteBtn.layer.borderColor = [UIColor stimDB_colorWithHex:0xD9D9D9].CGColor;
}

- (void)setUpUISelected {
    [self.navBgView setBackgroundColor:[UIColor stimDB_colorWithHex:0xDFF9F4]];
    [self.titleLabel setTextColor:[UIColor stimDB_colorWithHex:0x333333]];
    [self.navLabel setTextColor:[UIColor stimDB_colorWithHex:0x333333]];
    [self.qrcodeBtn setSelected:YES];
    [self.checkButton setSelected:YES];
    self.modifyBtn.layer.borderColor = [UIColor stimDB_colorWithHex:0x939393].CGColor;
    self.deleteBtn.layer.borderColor = [UIColor stimDB_colorWithHex:0x939393].CGColor;
}
...
- (void)setNavInfo:(NSDictionary *)navInfo {
    _navInfo = navInfo;
    NSString *navName = [navInfo objectForKey:STIMNavNameKey];
    NSString *navUrl = [navInfo objectForKey:STIMNavUrlKey];

...
static STIMAuthorizationManager *instance = nil;

@interface STIMAuthorizationManager ()

@property (nonatomic, strong) CLLocationManager *locationManager;

@end

@implementation STIMAuthorizationManager
...
//    [alertController addAction: [UIAlertAction actionWithTitle: [NSBundle stimDB_localizedStringForKey:@"Cancel"]

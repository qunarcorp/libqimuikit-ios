...
@interface STIMVoiceTimeRemindView()
{
...
@implementation STIMVoiceTimeRemindView
...
- (void)doSubViewInit
{
    ...
    [_imageView setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"registered_icon_quxiao"]];

...
@implementation QIMImageCropManager
...
+ (UIImage *)cropImageView:(UIImageView *)imageView toRect:(CGRect)rect zoomScale:(double)zoomScale containerView:(UIView *)containerView {
    ...
    cropedImage = [[QIMImagePickerManager manager] fixOrientation:cropedImage];
...
+ (UIImage *)sd_qim_animatedGIFWithData:(NSData *)data {
    ...
    if (count <= 1) {
        ...
        NSInteger maxCount = [QIMImagePickerConfig sharedInstance].gifPreviewMaxImagesCount ?: 50;

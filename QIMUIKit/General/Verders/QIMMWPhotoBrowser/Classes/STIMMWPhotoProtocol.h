...
// Notifications
#define STIMMWPHOTO_LOADING_DID_END_NOTIFICATION @"STIMMWPHOTO_LOADING_DID_END_NOTIFICATION"
#define STIMMWPHOTO_PROGRESS_NOTIFICATION @"STIMMWPHOTO_PROGRESS_NOTIFICATION"
...
// Otherwise you can use the STIMMWPhoto object or subclass it yourself to
// store more information per photo.
//
// You can see the STIMMWPhoto class for an example implementation of this protocol
//
@protocol STIMMWPhoto <NSObject>
...
// methods returns nil.
@property (nonatomic, strong) STIMImage *underlyingImage;
...
// See STIMMWPhoto object for an example implementation.

...
#import "STIMGroupPassworCell.h"

@implementation STIMGroupPassworCell{
    UIView *_rootView;
    UILabel *_titleLabel;
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _rootView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [STIMGroupPassworCell getCellHeight])];

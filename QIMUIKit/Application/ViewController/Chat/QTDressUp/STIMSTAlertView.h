...
typedef void (^STIMSTAlertViewBlock)();

typedef void (^STIMSTAlertViewStringBlock)(NSString*);

@interface STIMSTAlertView : NSObject <UIAlertViewDelegate>
...
Show a native UIAlertView with two buttons. The text and the title is custom, and is also custom the text of the buttons.
 ...
 @return The reference to the STIMSTAlertView
 */
...
- (id) initWithTitle:(NSString *)title
   ...
   cancelButtonBlock:(STIMSTAlertViewBlock)cancelButtonBlock
    otherButtonBlock:(STIMSTAlertViewBlock)otherButtonBlock;
...
- (id) initWithTitle:(NSString *)title
   ...
   otherButtonTitles:(NSString *)otherButtonTitles
   cancelButtonBlock:(STIMSTAlertViewBlock)cancelButtonBlock
    otherButtonBlock:(STIMSTAlertViewStringBlock)otherButtonBlock;

...
@interface STIMSingleChatVoiceCell ()
{
...
@implementation STIMSingleChatVoiceCell
{
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        if (_receiveImageArray == nil) {
            _receiveImageArray = [[NSArray alloc] initWithObjects:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"Chat_VoiceBubble_Friend_Icon1"],[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"Chat_VoiceBubble_Friend_Icon2"],[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"Chat_VoiceBubble_Friend_Icon3"],[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"Chat_VoiceBubble_Friend_Icon4"], nil];
        }
        
        if (_sentImageArray == nil) {
            _sentImageArray = [[NSArray alloc] initWithObjects:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"Chat_VoiceBubble_Myself_Icon1"],[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"Chat_VoiceBubble_Myself_Icon2"],[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"Chat_VoiceBubble_Myself_Icon3"],[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"Chat_VoiceBubble_Myself_Icon4"], nil];
        }
        ...
        [_errorButton setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"SignUpError"] forState:UIControlStateNormal];
...
- (void)onClick {
    ...
    if ([self.delegate playingVoiceWithMsgId:self.message.messageId]) {
        ...
        [[STIMPlayVoiceManager defaultPlayVoiceManager] playVoiceWithMsgId:nil];
        [_voiceImageView stopAnimating];
    } else {
        
        [[STIMPlayVoiceManager defaultPlayVoiceManager] playVoiceWithMsgId:self.message.messageId];
        [_timeLabel setText:@"00''"];
        [_voiceImageView startAnimating];
        if (self.message.messageDirection == STIMMessageDirection_Received) {
            //如果语音未读，mssageID落地
            [[STIMVoiceNoReadStateManager sharedVoiceNoReadStateManager] setVoiceNoReadStateWithMsgId:self.message.messageId ChatId:self.chatId withState:YES];
            //Mark By DB
//            self.message.readTag = 1;
            [self refreshUI];
        }
...
//    NSDictionary *infoDic = [self.message getMsgInfoDic];
    ...
    if (self.message.messageType == STIMMessageType_Voice) {
        ...
        if (self.message.messageDirection == STIMMessageDirection_Received) {
            ...
            UIImage *imageFriend = [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"chat_Avoice_bg"];
            ...
            [_voiceImageView setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"Chat_VoiceBubble_Friend_Icon1"]];
            ...
            //如果未读， 小红点显示
            BOOL unreadHidden = [[STIMVoiceNoReadStateManager sharedVoiceNoReadStateManager] isReadWithMsgId:self.message.messageId ChatId:self.chatId];
            ...
            [self.backView setFrame:frame];
            UIImage *imageMyself = [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"chat_Bvoice_bg"];
            ...
            [_voiceImageView setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"Chat_VoiceBubble_Myself_Icon1"]];
            ...
            [_timeLabel setFrame:timeFrame];
            [_errorButton setHidden:self.message.messageSendState != STIMMessageSendState_Faild];
            [_errorButton setHidden:self.message.messageSendState != STIMMessageSendState_Faild];
...
//    [self.message getMsgInfoDic];
    ...
    if (self.message.messageType == STIMMessageType_Voice) {
        ...
        if (self.message.messageDirection == STIMMessageDirection_Received) {
            ...
            [_dateLabel setFont:[UIFont fontWithName:FONT_NAME size:[[STIMCommonFont sharedInstance] currentFontSize] - 6]];

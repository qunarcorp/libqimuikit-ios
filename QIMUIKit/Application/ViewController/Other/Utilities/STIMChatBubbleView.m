...
@implementation STIMChatBubbleView
...
- (void)initMask {
    ...
    if (self.direction == STIMChatBubbleViewDirectionRight) {
...
//        CGPathAddArc(path, NULL, origin.x + size.width - sharpCorner, origin.y + sharpCorner, sharpCorner, 3 * M_PI_2, 0, NO);
    ...
    if (self.direction == STIMChatBubbleViewDirectionLeft) {
        _borderLayer.fillColor  = [UIColor stimDB_leftBallocColor].CGColor;
    }else{
        _borderLayer.fillColor  = [UIColor stimDB_rightBallocColor].CGColor;
    }
...
//        CGPathAddLineToPoint(path, NULL, origin.x + boderRadius, 27);
    ...
    if (self.direction == STIMChatBubbleViewDirectionLeft) {
        _borderLayer.fillColor  = [UIColor stimDB_leftBallocColor].CGColor;
        _borderLayer.strokeColor = stimDB_messageLeftBubbleBorderColor.CGColor;
    } else{
        _borderLayer.fillColor  = [UIColor stimDB_rightBallocColor].CGColor;
        _borderLayer.strokeColor = stimDB_messageRightBubbleBorderColor.CGColor;
    }
    _borderLayer.path = path;

...
@end
@implementation STIMPNActionRichTextCell{
    UIView *_bgView;
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        [_mainBgButton setBackgroundImage:[UIImage stimDB_imageFromColor:[UIColor qtalkTableDefaultColor]] forState:UIControlStateHighlighted];
        ...
        [_descBgView setBackgroundColor:[UIColor stimDB_colorWithHex:0.75 alpha:1]];
...
- (void)refreshUI{
    ...
    for (NSDictionary *dic in subActionList) {
        ...
        [subButton setBackgroundImage:[UIImage stimDB_imageFromColor:[UIColor qtalkTableDefaultColor]] forState:UIControlStateHighlighted];

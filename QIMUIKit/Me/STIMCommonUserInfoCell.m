...
@interface STIMCommonUserInfoCell ()

@property (nonatomic, strong) UIImageView *myQrcodeView;

@end

@implementation STIMCommonUserInfoCell
...
- (UIImageView *)myQrcodeView {
    if (!_myQrcodeView) {
        ...
        _myQrcodeView.image = [UIImage qimIconWithInfo:[STIMIconInfo iconInfoWithText:@"\U0000f10d" size:24 color:[UIColor stimDB_colorWithHex:0x9e9e9e alpha:1.0f]]];
    }

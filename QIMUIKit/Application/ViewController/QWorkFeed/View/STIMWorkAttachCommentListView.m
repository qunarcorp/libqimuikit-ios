//
//  STIMWorkAttachCommentListView.m
//  STIMUIKit
//
...
@interface STIMWorkAttachCommentListView () <UITableViewDelegate, UITableViewDataSource>

@end

@implementation STIMWorkAttachCommentListView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    STIMWorkCommentModel *commentModel = [self.attachCommentList objectAtIndex:indexPath.row];
    STIMWorkAttachCommentCell *cell = [tableView dequeueReusableCellWithIdentifier:@"attachCommentListCellId"];
    if (!cell) {
        cell = [[STIMWorkAttachCommentCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"attachCommentListCellId"];
    }
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    ...
    bgView.backgroundColor = [UIColor stimDB_colorWithHex:0xF3F3F5];
    UILabel *showMoreLabel = [[UILabel alloc] initWithFrame:CGRectMake(12, 5, self.width - 24, 15)];
    showMoreLabel.textColor = [UIColor stimDB_colorWithHex:0x00CABE];

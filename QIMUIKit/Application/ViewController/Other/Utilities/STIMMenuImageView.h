...
#define STIMMenuImageViewCancelHightlighted @"STIMMenuImageViewCancelHightlighted"
typedef enum{
    MA_Copy,        //拷贝
    MA_Repeater,    //转发
    MA_RepeaterToSMS,
...
@class STIMChatBubbleView;
@protocol STIMMenuImageViewDelegate;
@interface STIMMenuImageView : UIImageView<UIGestureRecognizerDelegate>
{
    STIMChatBubbleView      * _bubbleView;
}

@property (nonatomic, assign) MenuType menuType;
@property (nonatomic, weak) id <STIMMenuImageViewDelegate> delegate;
//如果是html只有删除按钮
...
@protocol STIMMenuImageViewDelegate <NSObject>
@optional

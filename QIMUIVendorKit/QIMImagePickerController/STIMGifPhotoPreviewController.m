//
//  STIMGifPhotoPreviewController.m
...
@interface STIMGifPhotoPreviewController () {
    UIView *_toolBar;
...
@implementation STIMGifPhotoPreviewController
...
- (void)configBottomToolBar {
    ...
    [[STIMImagePickerManager manager] getPhotosBytesWithArray:@[_model] completion:^(NSString *totalBytes) {

//
//  STIMWorkFeedAtUserTableViewCell.m
//  STIMUIKit
//
...
@interface STIMWorkFeedAtUserTableViewCell ()
...
@implementation STIMWorkFeedAtUserTableViewCell
...
- (UIImageView *)headerView {
    if (!_headerView) {
        ...
        _headerView.layer.borderColor = [UIColor stimDB_colorWithHex:0xE1E1E1].CGColor;
    }
    return _headerView;
}
...
- (UILabel *)nameLabel {
    if (!_nameLabel) {
        ...
        _nameLabel.textColor = [UIColor stimDB_colorWithHex:0x333333];
...
- (UILabel *)departmentLabel {
    if (!_departmentLabel) {
        ...
        _departmentLabel.textColor = [UIColor stimDB_colorWithHex:0x333333];
...
- (void)refreshUI {
    [self.headerView stimDB_setImageWithJid:self.userXmppId];
    [self.nameLabel setText:self.userName];
    NSDictionary *userInfo = [[STIMKit sharedInstance] getUserInfoByUserId:self.userXmppId];

...
@implementation QIMPickerView

#pragma mark - Singleton

+ (QIMPickerView*)sharedView {
  static dispatch_once_t once;
  static QIMPickerView *sharedView;
...
-(void)dismiss{
 [QIMPickerView dismissWithCompletion:self.onDismissCompletion];
}
...
-(void)setPickerHidden: (BOOL)hidden
  ...
  [UIView animateWithDuration:0.3
                   ...
                   animations:^{
                     ...
                     if(completed && hidden){
                       [QIMPickerView removePickerView];

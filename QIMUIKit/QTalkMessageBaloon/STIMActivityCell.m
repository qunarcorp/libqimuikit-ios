...
@implementation STIMActivityCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _activityLocaltionLabel.textColor = [UIColor stimDB_colorWithHex:0x9E9E9E];
        ...
        _activityCategoryLabel.textColor = [UIColor stimDB_colorWithHex:0x9E9E9E];
        ...
        _activityStartTimeLabel.textColor = [UIColor stimDB_colorWithHex:0x9E9E9E];
        ...
        _activityEndTimeLabel.textColor = [UIColor stimDB_colorWithHex:0x9E9E9E];

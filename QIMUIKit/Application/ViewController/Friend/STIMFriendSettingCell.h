...
@interface STIMFriendSettingItem : NSObject
...
@interface STIMFriendSettingCell : UITableViewCell
@property (nonatomic, strong) STIMFriendSettingItem *item;

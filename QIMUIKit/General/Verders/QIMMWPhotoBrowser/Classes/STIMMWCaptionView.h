...
@interface STIMMWCaptionView : UIToolbar

// Init
- (id)initWithPhoto:(id<STIMMWPhoto>)photo;
...
// If you need more data per photo then simply subclass STIMMWPhoto and return your

...
@protocol STIMTextStorageProtocol <NSObject>
@required
...
@protocol QCAppendTextStorageProtocol <STIMTextStorageProtocol>
...
@protocol STIMDrawStorageProtocol <QCAppendTextStorageProtocol>
...
@protocol STIMViewStorageProtocol <NSObject>

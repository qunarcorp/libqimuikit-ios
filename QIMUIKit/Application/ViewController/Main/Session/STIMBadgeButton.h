...
@class STIMBadgeButton;

typedef void (^BadgeDidClickBlock)(STIMBadgeButton *badgeButton);

typedef void (^BadgeDidDisappearBlock)(STIMBadgeButton *badgeButton);

@interface STIMBadgeButton : UIView
///badgeButton的宽度

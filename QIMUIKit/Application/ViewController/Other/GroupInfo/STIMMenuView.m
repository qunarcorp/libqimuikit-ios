...
- (void)copyMethod:(id)sender{
    ...
    if (self.coprText.length) {
        ...
        UIAlertView * alertView = [[UIAlertView alloc] initWithTitle:[NSBundle stimDB_localizedStringForKey:@"Reminder"] message:@"并没有什么东西可以复制的！" delegate:nil cancelButtonTitle:@"好的" otherButtonTitles:nil, nil];
        [alertView show];
    }
}

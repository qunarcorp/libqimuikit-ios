...
@implementation STIMAudioPlayer
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [_imageView setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"audioplayer_big_bg"]];
        ...
        [self.progressSlider setThumbImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"player_progressbar_current"] forState:UIControlStateNormal];
        [self.progressSlider setMinimumTrackImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"player_progressbar"] forState:UIControlStateNormal];
        [self.progressSlider setMaximumTrackImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"player_progressbar_bg"] forState:UIControlStateNormal];
...
- (void)play{
    [_playOrPause setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"player_pause"] forState:UIControlStateNormal];
    [self playClick:nil];
}
...
- (void)setPlayButtonImage:(BOOL)flag{
    if (flag) {
        [_playOrPause setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"player_button_play_normal"] forState:UIControlStateNormal];
        [_playOrPause setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"player_button_play_pressed"] forState:UIControlStateHighlighted];
    } else {
        [_playOrPause setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"player_button_stop_normal"] forState:UIControlStateNormal];
        [_playOrPause setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"player_button_stop_pressed"] forState:UIControlStateHighlighted];
    }
}

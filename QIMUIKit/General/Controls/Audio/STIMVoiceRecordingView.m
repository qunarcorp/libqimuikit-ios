...
#define Image_Name_0 [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"voiceRecording1"]
#define Image_Name_1 [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"voiceRecording2"]
#define Image_Name_2 [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"voiceRecording3"]
#define Image_Name_3 [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"voiceRecording4"]
#define Image_Name_4 [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"voiceRecording5"]
#define Image_Name_5 [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"voiceRecording6"]
#define Image_Name_6 [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"voiceRecording7"]

@interface STIMVoiceRecordingView() {
...
@implementation STIMVoiceRecordingView
...
- (void)doDataInit
{
    self.backgroundColor = [UIColor stimDB_colorWithHex:0x0 alpha:0.65];
...
//    [_staticImageView setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"voiceRecording"]];
//    [self addSubview:_staticImageView];
   ...
   [self addSubview:_imageView];
    ...
    [_maybeCancelView setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"SignUpError"]];
...
//    STIMVerboseLog(@"本次录音还有%f秒结束",remainTime);
//}

//
//  STIMWorkMomentUserIdentityCell.m
//  STIMUIKit
//
//  Created by lihaibin.li on 2019/1/11.
...
@interface STIMWorkMomentUserIdentityCell ()
...
@implementation STIMWorkMomentUserIdentityCell

- (UIButton *)replaceBtn {
    if (!_replaceBtn) {
        _replaceBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        [_replaceBtn setTitleColor:[UIColor stimDB_colorWithHex:0x00CABE] forState:UIControlStateNormal];
        [_replaceBtn setTitleColor:[UIColor stimDB_colorWithHex:0xBFBFBF] forState:UIControlStateDisabled];
        ...
        [_replaceBtn setImage:[UIImage qimIconWithInfo:[STIMIconInfo iconInfoWithText:@"\U0000f3d3" size:13 color:[UIColor stimDB_colorWithHex:0x00CABE]]] forState:UIControlStateNormal];
        [_replaceBtn setImage:[UIImage qimIconWithInfo:[STIMIconInfo iconInfoWithText:@"\U0000f3d3" size:13 color:[UIColor stimDB_colorWithHex:0xBFBFBF]]] forState:UIControlStateDisabled];
...
- (UILabel *)canNotReplaceLabel {
    if (!_canNotReplaceLabel) {
        ...
        _canNotReplaceLabel.textColor = [UIColor stimDB_colorWithHex:0xBFBFBF];
    }
...
- (void)setUserIdentitySelected:(BOOL)selected {
    ...
    if (selected == YES) {
        [self.imageView setImage:[UIImage qimIconWithInfo:[STIMIconInfo iconInfoWithText:@"\U0000e337" size:21 color:[UIColor stimDB_colorWithHex:0x00CABE]]]];
    } else {
        [self.imageView setImage:[UIImage qimIconWithInfo:[STIMIconInfo iconInfoWithText:@"\U0000e337" size:21 color:[UIColor stimDB_colorWithHex:0xE4E4E4]]]];
    }
}

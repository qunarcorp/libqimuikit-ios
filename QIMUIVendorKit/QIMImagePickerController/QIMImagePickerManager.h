...
@class QIMAlbumModel,QIMAssetModel;
@protocol QIMImagePickerControllerDelegate;
@interface QIMImagePickerManager : NSObject
...
@property (weak, nonatomic) id<QIMImagePickerControllerDelegate> pickerDelegate;
...
- (void)getAssetsFromFetchResult:(PHFetchResult *)result completion:(void (^)(NSArray<QIMAssetModel *> *models))completion;
- (void)getAssetsFromFetchResult:(PHFetchResult *)result allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(NSArray<QIMAssetModel *> *models))completion;
- (void)getAssetFromFetchResult:(PHFetchResult *)result atIndex:(NSInteger)index allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(QIMAssetModel *model))completion;

//
//  STIMWorkCommentModel.h
//  STIMUIKit
//
//  Created by lihaibin.li on 2019/1/15.
...
@interface STIMWorkCommentModel : NSObject
...
@property (nonatomic, strong) NSArray <STIMWorkCommentModel *> *childComments;   //子评论List

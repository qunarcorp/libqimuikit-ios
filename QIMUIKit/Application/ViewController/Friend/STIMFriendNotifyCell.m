...
@implementation STIMFriendNotifyCell{
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _headerImageView.image = [UIImage imageWithData:[STIMKit defaultUserHeaderImage]];
        ...
        [_openationButton setBackgroundImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"AV_Check_start_button_normal@2x"] forState:UIControlStateNormal];
        [_openationButton setBackgroundImage:[UIImage stimDB_imageFromColor:[UIColor clearColor]] forState:UIControlStateDisabled];
        ...
        UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(_nameLabel.left, [STIMFriendNotifyCell getCellHeight]-0.5, [UIScreen mainScreen].bounds.size.width-_nameLabel.left, 0.5)];
...
- (void)refreshUI{
    ...
    /*
    UIImage * headImage = [[STIMKit sharedInstance] getUserHeaderImageByUserId:jid?jid:@""];
    if (headImage) {

...
@interface STIMVideoPlayerController () {
    AVPlayer *_player;
...
@implementation STIMVideoPlayerController
...
- (void)configMoviePlayer {
    [[STIMImagePickerManager manager] getPhotoWithAsset:_model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
        if (!isDegraded && photo) {
            self->_cover = photo;
            self->_doneButton.enabled = YES;
        }
    }];
    [[STIMImagePickerManager manager] getVideoWithAsset:_model.asset completion:^(AVPlayerItem *playerItem, NSDictionary *info) {

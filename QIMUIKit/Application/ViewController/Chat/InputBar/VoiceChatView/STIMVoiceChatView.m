...
#import "STIMVoiceGoalBar.h"
#import "STIMTextBar.h"
#import "NSBundle+STIMLibrary.h"

@interface STIMVoiceChatView ()
{
    ...
    STIMVoiceGoalBar        * _voiceGoalBar;
...
@implementation STIMVoiceChatView

-(instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        
        self.backgroundColor = [UIColor stimDB_colorWithHex:0xebecef alpha:1];
        ...
        [_voiceBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_voice_button_icon"] forState:UIControlStateNormal];
        [_voiceBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_voice_button_icon"] forState:UIControlStateHighlighted];
        [_voiceBtn setBackgroundImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_voice_button_nor"] forState:UIControlStateNormal];
        [_voiceBtn setBackgroundImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_voice_button_press"] forState:UIControlStateHighlighted];
//        [_voiceBtn setBackgroundColor: [UIColor colorWithRed:92/255.0 green:197/255.0 blue:127/255.0 alpha:1/1.0]];
        ...
        [_auditionBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_voice_operate_listen_nor"] forState:UIControlStateNormal];
        [_auditionBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_voice_operate_listen_press"] forState:UIControlStateSelected];
        [_auditionBtn setBackgroundImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_voice_operate_nor"] forState:UIControlStateNormal];
        [_auditionBtn setBackgroundImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_voice_operate_press"] forState:UIControlStateSelected];
        [self addSubview:_auditionBtn];
        
        _delBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        _delBtn.hidden = YES;
        [_delBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_voice_operate_delete_nor"] forState:UIControlStateNormal];
        [_delBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_voice_operate_delete_press"] forState:UIControlStateSelected];
        [_delBtn setBackgroundImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_voice_operate_nor"] forState:UIControlStateNormal];
        [_delBtn setBackgroundImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_voice_operate_press"] forState:UIControlStateSelected];
        [self addSubview:_delBtn];
        
        
        _cancelBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        [_cancelBtn setTitle:[NSBundle stimDB_localizedStringForKey:@"Cancel"] forState:UIControlStateNormal];
        [_cancelBtn setBackgroundColor:[UIColor whiteColor]];
        [_cancelBtn setTitleColor:[UIColor stimDB_colorWithHex:0x1da4e9 alpha:1] forState:UIControlStateNormal];
        ...
        [_sendBtn setTitle:[NSBundle stimDB_localizedStringForKey:@"common_send"] forState:UIControlStateNormal];
        [_sendBtn setBackgroundColor:[UIColor whiteColor]];
        [_sendBtn setTitleColor:[UIColor stimDB_colorWithHex:0x1da4e9 alpha:1] forState:UIControlStateNormal];
...
//    STIMVerboseLog(@"Touch x : %f y : %f", touchPoint.x, touchPoint.y);
    ...
    [_voiceBtn setBackgroundImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_voice_button_press"] forState:UIControlStateNormal];
}
...
//        STIMVerboseLog(@"Touch x : %f y : %f", touchPoint.x, touchPoint.y);
        if (touchPoint.y < 0) {
            ...
            if (_voiceBtnStatus == VoiceBtnStatusAuditionStart) {
                ...
                [_voiceBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_record_stop_nor"] forState:UIControlStateNormal];
                [_voiceBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_record_stop_press"] forState:UIControlStateHighlighted];
                if (self.delegate && [self.delegate respondsToSelector:@selector(playCurrentVoice)]) {
                     _remoteAudioPlayer = [(STIMTextBar *)self.delegate playCurrentVoice];
                ...
                [_voiceBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_record_play_nor"] forState:UIControlStateNormal];
                [_voiceBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_record_play_press"] forState:UIControlStateHighlighted];
                if (self.delegate && [self.delegate respondsToSelector:@selector(stopCurrentVoice)]) {
                    [(STIMTextBar *)self.delegate stopCurrentVoice];
                    NSTimeInterval timeout = [(STIMTextBar *)self.delegate getCurrentVoiceTimeout];
...
//    STIMVerboseLog(@"Touch x : %f y : %f", touchPoint.x, touchPoint.y);
    ...
    if (currentLength < _auditionBtn.width / 2) {
        ...
        [_voiceBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_record_play_nor"] forState:UIControlStateNormal];
        [_voiceBtn setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_record_play_press"] forState:UIControlStateHighlighted];
        [_voiceBtn setBackgroundImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_record_finish_button"] forState:UIControlStateNormal];
        [_voiceBtn setBackgroundImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aio_record_finish_button"] forState:UIControlStateHighlighted];
        if (self.delegate && [self.delegate respondsToSelector:@selector(voiceChatView:RecordingAtStatus:)]) {
...
//            NSTimeInterval timeout = [(IMTextBar *)self.delegate getCurrentVoiceTimeout];
            ...
            if (!_voiceGoalBar) {
                _voiceGoalBar = [[STIMVoiceGoalBar alloc]initWithFrame:CGRectMake(0, 0, kVoiceBtnWidth, kVoiceBtnWidth)];
...
//            STIMVerboseLog(@"_remoteAudioPlayer===%lf", _remoteAudioPlayer.currentTime);
...
- (void)recordingRefresh
{
    ...
    if (_canRecording) {
        if (_timeLabelDisplayTime) {
            ...
            _timeLabel.text = [NSString stringWithFormat:@"%d:%02d",minutes,second];
//            STIMVerboseLog(@"_recordingSeconds====%lf", _recordingSeconds);
        }

...
@implementation STIMVoiceGoalBarPercentLayer
@synthesize percent;
...
-(void)DrawRight:(CGContextRef)ctx {
    ...
    CGContextSetFillColorWithColor(ctx, [UIColor stimDB_colorWithHex:0x1da4e9 alpha:1].CGColor);
...
-(void)DrawLeft:(CGContextRef)ctx {
    ...
    CGContextSetFillColorWithColor(ctx, [UIColor stimDB_colorWithHex:0xdadadc alpha:1].CGColor);

...
@interface STIMCustomTabBar(){
    
}

@end

@implementation STIMCustomTabBar
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [lineView setBackgroundColor:[UIColor stimDB_colorWithHex:0xEAEAEA]];
        ...
        for (int i = 0 ; i < _itemCount ; i++ ) {
            ...
            [badgeNumberLabel setBackgroundColor:stimDB_mainViewBadgeNumberLabelBgColor];
            [badgeNumberLabel setTextColor:[UIColor whiteColor]];
            [badgeNumberLabel setFont:[UIFont systemFontOfSize:stimDB_mainViewBadgeNumberLabelTextFont]];

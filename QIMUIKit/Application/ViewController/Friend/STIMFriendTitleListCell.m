...
@interface STIMFriendTitleListCell(){
...
@implementation STIMFriendTitleListCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [_imageView setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"buddy_header_arrow@2x"]];
        ...
        [_titleLabel setFont:[UIFont systemFontOfSize:[[STIMCommonFont sharedInstance] currentFontSize] - 2]];
        ...
        [_descLabel setFont:[UIFont systemFontOfSize:[[STIMCommonFont sharedInstance] currentFontSize] - 4]];
...
- (void)refresh {
    ...
    _titleLabel.font = [UIFont systemFontOfSize:[[STIMCommonFont sharedInstance] currentFontSize] - 2];
    
    _descLabel.frame = CGRectMake(self.width - 90, 0, 80, [self.class getCellHeight]);
    _descLabel.font = [UIFont systemFontOfSize:[[STIMCommonFont sharedInstance] currentFontSize] - 4];

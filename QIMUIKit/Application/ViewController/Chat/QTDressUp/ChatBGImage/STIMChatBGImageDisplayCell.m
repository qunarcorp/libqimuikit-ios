...
@interface STIMChatBGImageDisplayCell()
{
...
@implementation STIMChatBGImageDisplayCell
...
-(void)setImages:(NSArray *)images
{
    ...
    for (__strong UIImage * image in images) {
        ...
        imageView.backgroundColor = [UIColor stimDB_colorWithHex:0xebecef alpha:1];

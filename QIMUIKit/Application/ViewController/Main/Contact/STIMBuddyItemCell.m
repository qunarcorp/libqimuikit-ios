...
@implementation STIMBuddyItemCell
...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextSetStrokeColorWithColor(context, [UIColor stimDB_colorWithHex:0xeaeaea alpha:1].CGColor);

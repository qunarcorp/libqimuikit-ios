...
@class QIMAlbumModel,STIMAssetModel;
@protocol STIMImagePickerControllerDelegate;
@interface STIMImagePickerManager : NSObject
...
@property (weak, nonatomic) id<STIMImagePickerControllerDelegate> pickerDelegate;
...
- (void)getAllAlbums:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage needFetchAssets:(BOOL)needFetchAssets completion:(void (^)(NSArray<QIMAlbumModel *> *models))completion;

/// Get Assets 获得Asset数组
- (void)getAssetsFromFetchResult:(PHFetchResult *)result completion:(void (^)(NSArray<STIMAssetModel *> *models))completion;
- (void)getAssetsFromFetchResult:(PHFetchResult *)result allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(NSArray<STIMAssetModel *> *models))completion;
- (void)getAssetFromFetchResult:(PHFetchResult *)result atIndex:(NSInteger)index allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(STIMAssetModel *model))completion;

/// Get photo 获得照片
- (PHImageRequestID)getPostImageWithAlbumModel:(QIMAlbumModel *)model completion:(void (^)(UIImage *postImage))completion;
...
/// for STIMImagePreviewController
...
//@interface QIMSortDescriptor : NSSortDescriptor
//
//@end

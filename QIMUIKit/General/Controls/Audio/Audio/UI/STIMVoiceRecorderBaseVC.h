...
@protocol STIMVoiceRecorderBaseVCDelegate <NSObject>

//录音完成回调，返回文件路径和文件名
- (void)STIMVoiceRecorderBaseVCRecordFinish:(NSString *)_filePath fileName:(NSString*)_fileName;
- (void)VoiceRecorderDidFinishWithAmrData:(NSData *)_amrData WithDuration:(int)duration;

@end

@interface STIMVoiceRecorderBaseVC : UIViewController{
...
@property (assign, nonatomic)           id<STIMVoiceRecorderBaseVCDelegate> vrbDelegate;

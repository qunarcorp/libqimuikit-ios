...
@interface STIMPhotoPreviewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate> {
...
//    UIImageView     * _editImageDisplayView;//展示图片
    ...
    STIMImageClipView   * _editImageClipView;//图片裁剪
    STIMImageDoodleView * _editImageDoodleView;//涂鸦
...
@implementation STIMPhotoPreviewController

- (void)viewDidLoad {
    [super viewDidLoad];
    [STIMImagePickerManager manager].shouldFixOrientation = YES;
    STIMImagePickerController *_tzImagePickerVc = (STIMImagePickerController *)self.navigationController;
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    [STIMImagePickerManager manager].shouldFixOrientation = NO;
}
...
- (void)initEditToolsBar {
    ...
    [_editDuangBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"aio_photo_filter"] forState:UIControlStateNormal];
    [_editDuangBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"aio_photo_filter_pressed"] forState:UIControlStateHighlighted];
    [_editDuangBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"aio_photo_filter_pressed"] forState:UIControlStateSelected];
    ...
    [_editDoodleBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"aio_photo_brush"] forState:UIControlStateNormal];
    [_editDoodleBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"aio_photo_brush_pressed"] forState:UIControlStateHighlighted];
    [_editDoodleBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"aio_photo_brush_pressed"] forState:UIControlStateSelected];
    ...
    [_editClipsBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"aio_photo_cut"] forState:UIControlStateNormal];
    [_editClipsBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"aio_photo_cut_pressed"] forState:UIControlStateHighlighted];
    [_editClipsBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"aio_photo_cut_pressed"] forState:UIControlStateSelected];
...
- (void)initClipButtonBar {
    ...
    [roateBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"pe_crop_left_ccw_normal"] forState:UIControlStateNormal];
    [roateBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"pe_crop_left_ccw_pressed"] forState:UIControlStateHighlighted];
    ...
    [cancelBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"pe_crop_left_ccw_normal"] forState:UIControlStateNormal];
    [cancelBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"pe_crop_left_ccw_pressed"] forState:UIControlStateHighlighted];
    ...
    [okBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"pe_crop_left_ccw_normal"] forState:UIControlStateNormal];
    [okBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"pe_crop_left_ccw_pressed"] forState:UIControlStateHighlighted];
...
- (void)addDuangView {
    ...
    for (NSString * imageStr in _editDataSource) {
        ...
        imageView.image = [self getDuangImageWithIndexTag:i originalImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:imageStr]];
...
- (void)addOrientationView {
    ...
    [orientationLeftBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"pe_crop_left_ccw_normal"] forState:UIControlStateNormal];
    [orientationLeftBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"pe_crop_left_ccw_pressed"] forState:UIControlStateHighlighted];
    ...
    [orientationRightBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"pe_crop_right_ccw_normal"] forState:UIControlStateNormal];
    [orientationRightBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"pe_crop_right_ccw_pressed"] forState:UIControlStateHighlighted];
...
- (void)addDoodleSelectBar {
    ...
    [cleanBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"pe_doodle_eraser_normal"] forState:UIControlStateNormal];
    [cleanBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"pe_doodle_eraser_pressed"] forState:UIControlStateHighlighted];
    [cleanBtn setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"pe_doodle_eraser_pressed"] forState:UIControlStateSelected];
...
- (void)configCustomNaviBar {
    ...
    [_backButton setImage:[UIImage qim_imageNamedFromSTIMImagePickerBundle:@"navi_back"] forState:UIControlStateNormal];
...
- (void)configCollectionView {
    ...
    [_collectionView registerClass:[STIMPhotoPreviewCell class] forCellWithReuseIdentifier:@"STIMPhotoPreviewCell"];
...
- (void)configCropView {
    ...
    if (_tzImagePickerVc.maxImagesCount <= 1 && _tzImagePickerVc.allowCrop && _tzImagePickerVc.allowPickingImage) {
        ...
        [STIMImageCropManager overlayClippingWithView:_cropBgView cropRect:_tzImagePickerVc.cropRect containerView:self.view needCircleCrop:_tzImagePickerVc.needCircleCrop];
...
- (void)viewDidLayoutSubviews {
    ...
    CGFloat statusBarHeight = [STIMCommonTools qim_statusBarHeight];
    ...
    CGFloat toolBarHeight = [STIMCommonTools qim_isIPhoneX] ? 44 + (83 - 49) : 44;
    CGFloat toolBarTop = self.view.qim_height - toolBarHeight;
    
    CGFloat editToolBarHeight = [STIMCommonTools qim_isIPhoneX] ? 80 + (83 - 49) : 80;
...
- (void)select:(UIButton *)selectButton {
    STIMImagePickerController *_tzImagePickerVc = (STIMImagePickerController *)self.navigationController;
    STIMAssetModel *model = _models[self.currentIndex];
    if (!selectButton.isSelected) {
        ...
        if (_tzImagePickerVc.selectedModels.count >= _tzImagePickerVc.maxImagesCount) {
            ...
            if (model.type == STIMAssetModelMediaTypeVideo && !_tzImagePickerVc.allowPickingMultipleVideo) {
        ...
        for (STIMAssetModel *model_item in selectedModels) {
            if ([model.asset.localIdentifier isEqualToString:model_item.asset.localIdentifier]) {
                ...
                for (NSInteger i = 0; i < selectedModelsTmp.count; i++) {
                    STIMAssetModel *model = selectedModelsTmp[i];
...
- (void)backButtonClick {
    if (self.navigationController.childViewControllers.count < 2) {
        ...
        if ([self.navigationController isKindOfClass: [STIMImagePickerController class]]) {
            STIMImagePickerController *nav = (STIMImagePickerController *)self.navigationController;
...
-(void)imageViewHandle:(UITapGestureRecognizer *)tapGes {
    ...
    STIMPhotoPreviewCell *cell = (STIMPhotoPreviewCell *)[_collectionView cellForItemAtIndexPath:indexPath];
...
- (void)orientationBtnHandle:(id)sender {
    ...
    STIMPhotoPreviewCell *cell = (STIMPhotoPreviewCell *)[_collectionView cellForItemAtIndexPath:indexPath];
    UIImage *originImage = cell.previewView.imageView.image;
    cell.previewView.imageView.image = [STIMImageUtil image:originImage rotation:UIImageOrientationLeft];
...
//        _editImageClipView = [[STIMImageClipView alloc] initWithFrame:CGRectMake(20, 20, CGRectGetWidth([UIScreen mainScreen].bounds) - 40, _editToolBar.top - 40) imageView:cell.previewView.imageView.image];
...
- (void)setUpSTIMImageDoodleView
{
    _editImageDoodleView = [[STIMImageDoodleView alloc] initWithFrame:CGRectZero];
    _editImageDoodleView.drawingMode = DrawingModePaint;
...
- (UIImage *)getDuangImageWithIndexTag:(NSInteger)indexTag originalImage:(UIImage *)originalImage {
    ...
    switch (indexTag) {
        ...
        case 1:
        {
            image = [STIMImageUtil imageWithImage:originalImage withColorMatrix:qim_colormatrix_lomo];
        }
            break;
        case 2:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:qim_colormatrix_heibai];
        }
            break;
        case 3:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:qim_colormatrix_huajiu];
        }
            break;
        case 4:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:qim_colormatrix_gete];
        }
            break;
        case 5:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:qim_colormatrix_ruise];
        }
            break;
        case 6:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:qim_colormatrix_danya];
        }
            break;
        case 7:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:qim_colormatrix_jiuhong];
        }
            break;
        case 8:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:qim_colormatrix_qingning];
        }
            break;
        case 9:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:qim_colormatrix_langman];
        }
            break;
        case 10:
        {
            image =  [STIMImageUtil imageWithImage:originalImage withColorMatrix:qim_colormatrix_guangyun];
        }
            break;
        case 11:
        {
            image = [STIMImageUtil imageWithImage:originalImage withColorMatrix:qim_colormatrix_landiao];
            
        }
            break;
        case 12:
        {
            image = [STIMImageUtil imageWithImage:originalImage withColorMatrix:qim_colormatrix_menghuan];
            
        }
            break;
        case 13:
        {
            image = [STIMImageUtil imageWithImage:originalImage withColorMatrix:qim_colormatrix_yese];
...
- (void)doneButtonClick {
    ...
    NSIndexPath *indexPath = [NSIndexPath indexPathForItem:self.currentIndex inSection:0];
    STIMPhotoPreviewCell *cell = (STIMPhotoPreviewCell *)[_collectionView cellForItemAtIndexPath:indexPath];
    if (_tzImagePickerVc.allowCrop && [cell isKindOfClass:[STIMPhotoPreviewCell class]]) { // 裁剪状态
        _doneButton.enabled = NO;
        [_tzImagePickerVc showProgressHUD];
        UIImage *cropedImage = [STIMImageCropManager cropImageView:cell.previewView.imageView toRect:_tzImagePickerVc.cropRect zoomScale:cell.previewView.scrollView.zoomScale containerView:self.view];
        if (_tzImagePickerVc.needCircleCrop) {
            cropedImage = [STIMImageCropManager circularClipImage:cropedImage];
        }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_tzImagePickerVc.allowPickingMultipleVideo && model.type == STIMAssetModelMediaTypeVideo) {
        cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"QIMVideoPreviewCell" forIndexPath:indexPath];
    } else if (_tzImagePickerVc.allowPickingMultipleVideo && model.type == STIMAssetModelMediaTypePhotoGif && _tzImagePickerVc.allowPickingGif) {
        cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"QIMGifPreviewCell" forIndexPath:indexPath];
    } else {
        cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"STIMPhotoPreviewCell" forIndexPath:indexPath];
        STIMPhotoPreviewCell *photoPreviewCell = (STIMPhotoPreviewCell *)cell;
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    if ([cell isKindOfClass:[STIMPhotoPreviewCell class]]) {
        [(STIMPhotoPreviewCell *)cell recoverSubviews];
    }
}
...
- (void)refreshNaviBarAndBottomBarState {
    ...
    // 如果正在预览的是视频，隐藏原图按钮
    if (!_isHideNaviBar) {
        if (model.type == STIMAssetModelMediaTypeVideo) {
    ...
    if (![[STIMImagePickerManager manager] isPhotoSelectableWithAsset:model.asset]) {
...
- (void)showPhotoBytes {
    [[STIMImagePickerManager manager] getPhotosBytesWithArray:@[_models[self.currentIndex]] completion:^(NSString *totalBytes) {
        self->_originalPhotoLabel.text = [NSString stringWithFormat:@"(%@)",totalBytes];
    }];
}

- (NSInteger)currentIndex {
    return [STIMCommonTools qim_isRightToLeftLayout] ? self.models.count - _currentIndex - 1 : _currentIndex;
}

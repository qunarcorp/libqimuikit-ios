...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _rootView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [STIMQRCodeCell getCellHeight])];
        ...
        [_titleLabel setText:[NSBundle stimDB_localizedStringForKey:@"group_qr_code"]];
        ...
        _QRicon.image = [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"QRCode"];

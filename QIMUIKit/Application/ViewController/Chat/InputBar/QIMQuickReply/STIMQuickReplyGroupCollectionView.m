//
//  STIMQuickReplyGroupCollectionView.m
//  STIMUIKit
//
...
@interface STIMQuickReplyGroupCollectionView () <UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation STIMQuickReplyGroupCollectionView
...
- (UICollectionView *)groupCollectionView {
    if (!_groupCollectionView) {
        ...
        [_groupCollectionView registerClass:[STIMQuickReplyGroupTagCell class] forCellWithReuseIdentifier:@"xxx"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    STIMQuickReplyGroupTagCell *cell = (STIMQuickReplyGroupTagCell *)[collectionView dequeueReusableCellWithReuseIdentifier:@"xxx" forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row == self.currentSelectIndex) {
        cell.contentView.backgroundColor = [UIColor stimDB_colorWithHex:0x15b0f9 alpha:1.0];
    } else {

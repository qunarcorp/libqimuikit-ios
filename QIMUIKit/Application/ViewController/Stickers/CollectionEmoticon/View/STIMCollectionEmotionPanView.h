...
@class STIMCollectionEmotionPanView;

@protocol  STIMDragCellCollectionViewDelegate<UICollectionViewDelegate>
 ...
 *  某个cell正在移动的时候
 */
- (void)dragCellCollectionViewCellisMoving:(STIMCollectionEmotionPanView *)collectionView;
/**
 ...
 */
- (void)dragCellCollectionView:(STIMCollectionEmotionPanView *)collectionView moveCellFromIndexPath:(NSIndexPath *)fromIndexPath toIndexPath:(NSIndexPath *)toIndexPath;

@end

@protocol  STIMDragCellCollectionViewDataSource<UICollectionViewDataSource>
...
@interface STIMCollectionEmotionPanView : UICollectionView

@property (nonatomic, assign) id<STIMDragCellCollectionViewDelegate> qimDragDelegate;
@property (nonatomic, assign) id<STIMDragCellCollectionViewDataSource> qimDragDataSource;

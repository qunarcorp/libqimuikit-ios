...
#import "STIMViewStorage.h"

@interface STIMTextContainer : NSObject
...
@interface STIMTextContainer (Add)
/**
...
#pragma mark - append
@interface STIMTextContainer (Append)
...
#pragma mark - Link
@interface STIMTextContainer (Link)
...
@interface STIMTextContainer (UIImage)
...
@interface STIMTextContainer (UIView)

...
///默认颜色
#define KDefaultColor  [UIColor stimDB_colorWithHex:0xEB524A alpha:1.0]
...
@implementation STIMBadgeButton{
    CGFloat r1;
    CGFloat r2;
    CGPoint orgialPoint;
    CGPoint pointA;
...
- (void)displayBomAnimationWithPoint:(CGPoint )point{
    ...
    for (int i =0; i < 4; i++) {
        ...
        UIImage *img  = [UIImage stimDB_imageNamedFromSTIMUIKitBundle:imgName];
        if (img) {

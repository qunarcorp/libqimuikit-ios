...
@implementation STIMMoviePlayer
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [_playButtonView setBackgroundColor:[UIColor stimDB_colorWithHex:0x0 alpha:0.5]];
...
- (void)setPlayButtonImage:(BOOL)flag{
    if (flag) {
        [_playOrPause setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"video_button_play_normal"] forState:UIControlStateNormal];
        [_playOrPause setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"video_button_play_pressed"] forState:UIControlStateHighlighted];
    } else { 
        [_playOrPause setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"video_button_stop_normal"] forState:UIControlStateNormal];
        [_playOrPause setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"video_button_stop_pressed"] forState:UIControlStateHighlighted];
    }
}

...
@implementation STIMMessageHelperVC
...
- (void)initWithNav {
    [self.navigationItem setTitle:[NSBundle stimDB_localizedStringForKey:@"contact_tab_not_read"]];
}
...
- (void)getNotReadMsgList {
    ...
    self.recentContactArray = [NSMutableArray arrayWithArray:[[STIMKit sharedInstance] getNotReadSessionList]];
}

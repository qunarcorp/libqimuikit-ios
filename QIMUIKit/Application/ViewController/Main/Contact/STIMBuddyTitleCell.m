...
@implementation STIMBuddyTitleCell
...
- (void)refresh {
    ...
    parentLayer.contents = (id)[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"triangleSmall"].CGImage;
}

...
#import "STIMGroupMaxMemberCell.h"
#import "NSBundle+STIMLibrary.h"

@implementation STIMGroupMaxMemberCell{
    UIView *_rootView;
    UILabel *_titleLabel;
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _rootView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [STIMGroupMaxMemberCell getCellHeight])];
        ...
        [_titleLabel setText:[NSBundle stimDB_localizedStringForKey:@"myself_max_count"]];
        ...
        [line setBackgroundColor:[UIColor stimDB_colorWithHex:0xd1d1d1 alpha:1]];

...
@interface STIMWorkMomentVideoView ()
...
@implementation STIMWorkMomentVideoView
...
- (UIImageView *)playImgView {
    if (!_playImgView) {
        ...
        _playImgView.image = [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"q_work_video_play"];
    }
    return _playImgView;
}
...
- (void)setVideoModel:(STIMVideoModel *)videoModel {
    _videoModel = videoModel;
    [self.thubImgView stimDB_setImageWithURL:[NSURL URLWithString:videoModel.ThumbUrl] placeholderImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"PhotoDownloadPlaceHolder"]];
}

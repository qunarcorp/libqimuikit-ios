...
@interface STIMValidationFriendVC()<UITableViewDataSource,UITableViewDelegate>

@end

@implementation STIMValidationFriendVC{
...
- (void)onDoneClick{
    ...
    [[STIMKit sharedInstance] validationFriendWithXmppId:self.xmppId WithReason:_validationTextView.text];

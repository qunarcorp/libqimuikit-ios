...
#import "STIMAACollectionDescCell.h"
#import "STIMUserInfoUtil.h"
#import "STIMJSONSerializer.h"

@interface STIMAACollectionDescCell ()
{
...
@implementation STIMAACollectionDescCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _flagView.image = [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"aa_icon"];

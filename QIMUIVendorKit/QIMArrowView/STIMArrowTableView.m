...
#import "STIMArrowCellTableViewCell.h"

@interface STIMArrowTableView ()

@property (nonatomic, strong) UITableView *tableView;

@end

@implementation STIMArrowTableView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    STIMArrowCellTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (!cell) {
        cell = [[STIMArrowCellTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
    }

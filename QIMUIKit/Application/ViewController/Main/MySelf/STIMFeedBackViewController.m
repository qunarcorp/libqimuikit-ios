...
@interface STIMFeedBackViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation STIMFeedBackViewController
...
- (void)setUpNavBar {
    ...
    self.title = [NSBundle stimDB_localizedStringForKey:@"About_tab_feedBack"];
//    self.navigationController.navigationBar.translucent = NO;
//    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:[NSBundle stimDB_localizedStringForKey:@"Back"] style:UIBarButtonItemStylePlain target:self action:@selector(goBack)];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSDictionary *dict = [[STIMKit sharedInstance] getUserInfoByUserId:item];
...
- (void)openEngineerSessionWithEngineerUserinfo:(NSDictionary *)dict {
    ...
    [STIMFastEntrance openSingleChatVCByUserId:jid];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSDictionary *dict = [[STIMKit sharedInstance] getUserInfoByUserId:value];
    STIMFriendListCell *nodeCell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (nodeCell == nil) {
        nodeCell = [[STIMFriendListCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
    }
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSDictionary *dict = [[STIMKit sharedInstance] getUserInfoByUserId:item];
    return [STIMFriendListCell getCellHeightForDesc:[dict objectForKey:@"DescInfo"]];
}

...
NSString * const STIMMMbackgroundColor = @"backgroundColor";
NSString * const STIMMMtextColor = @"textColor";
NSString * const STIMMMtoolbarColor = @"toolbarColor";
NSString * const STIMMMbuttonColor = @"buttonColor";
NSString * const STIMMMfont = @"font";
NSString * const STIMMMvalueY = @"yValueFromTop";
NSString * const STIMMMselectedObject = @"selectedObject";
NSString * const STIMMMtoolbarBackgroundImage = @"toolbarBackgroundImage";

@interface STIMPickerView () <UIPickerViewDelegate, UIPickerViewDataSource>
...
@implementation STIMPickerView

#pragma mark - Singleton

+ (STIMPickerView*)sharedView {
  static dispatch_once_t once;
  static STIMPickerView *sharedView;
...
-(void)dismiss{
 [STIMPickerView dismissWithCompletion:self.onDismissCompletion];
}
...
-(void)setPickerHidden: (BOOL)hidden
  ...
  [UIView animateWithDuration:0.3
                   ...
                   animations:^{
                     ...
                     if(completed && hidden){
                       [STIMPickerView removePickerView];
...
-(void)initializePickerViewInView: (UIView *)view
  ...
  id chosenObject = options[STIMMMselectedObject];
  ...
  UIColor *pickerViewBackgroundColor = [[UIColor alloc] initWithCGColor:[options[STIMMMbackgroundColor] CGColor]];
  UIColor *pickerViewTextColor = [[UIColor alloc] initWithCGColor:[options[STIMMMtextColor] CGColor]];
  UIColor *toolbarBackgroundColor = [[UIColor alloc] initWithCGColor:[options[STIMMMtoolbarColor] CGColor]];
  UIColor *buttonTextColor = [[UIColor alloc] initWithCGColor:[options[STIMMMbuttonColor] CGColor]];
  UIFont *pickerViewFont = [[UIFont alloc] init];
  pickerViewFont = options[STIMMMfont];
  _yValueFromTop = [options[STIMMMvalueY] floatValue];
  
  [self setFrame: view.bounds];
  [self setBackgroundColor:[UIColor clearColor]];
  
  UIImage * toolbarImage = options[STIMMMtoolbarBackgroundImage];
...
//   patternImageView.image = [[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"texture"] resizableImageWithCapInsets:UIEdgeInsetsZero];

...
@implementation STIMNotReadMsgTipViews{ 
    UIView *_backView;
    UIView *_leftView;
...
- (CGFloat)getWidthForNotReadCount:(int)notReadCount{
    _title = [NSString stringWithFormat:@"%d%@",notReadCount, [NSBundle stimDB_localizedStringForKey:@"moment_new_messages"]];
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [_titleLabel setTextColor:stimDB_newmessageUpArrowTextColor];

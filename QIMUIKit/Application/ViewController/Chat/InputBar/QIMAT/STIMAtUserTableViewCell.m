...
@interface STIMAtUserTableViewCell ()
...
@implementation STIMAtUserTableViewCell
...
- (UILabel *)nameLabel {
    if (!_nameLabel) {
        _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(60, 10, [[UIScreen mainScreen] stimDB_rightWidth] - 70, 20)];
...
- (void)refreshUI {
    [self.headerView stimDB_setImageWithJid:self.jid];

...
- (void)viewDidLoad {
    ...
    NSString *htmlPath = [NSBundle stimDB_myLibraryResourcePathWithClassName:@"QIMSourceCode" BundleName:@"QIMSourceCode" pathForResource:@"applicationCode" ofType:@"html"];
    NSString *cssFile = [NSBundle stimDB_myLibraryResourcePathWithClassName:@"QIMSourceCode" BundleName:@"QIMSourceCode" pathForResource:@"application" ofType:@"css"];
    NSString *jsFile = [NSBundle stimDB_myLibraryResourcePathWithClassName:@"QIMSourceCode" BundleName:@"QIMSourceCode" pathForResource:@"application" ofType:@"js"];

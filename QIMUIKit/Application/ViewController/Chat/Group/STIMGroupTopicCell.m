...
#import "STIMGroupTopicCell.h"

@implementation STIMGroupTopicCell{
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        [_topicLable setBackgroundColor:[UIColor stimDB_colorWithHex:0xe5e5e5 alpha:1]];

...
#import "STIMChatRecorderView.h"
#import "UIImage+STIMUIKit.h"

#define kTrashImage1         [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"recorder_trash_can0"]
#define kTrashImage2         [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"recorder_trash_can1"]
#define kTrashImage3         [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"recorder_trash_can2"]

@interface STIMChatRecorderView(){
...
@implementation STIMChatRecorderView
...
- (void)initilization{
    ...
    peakImageAry = [[NSArray alloc]initWithObjects:
                    [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"speaker_0"],
                    [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"speaker_1"],
                    [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"speaker_2"],
                    [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"speaker_3"], nil];

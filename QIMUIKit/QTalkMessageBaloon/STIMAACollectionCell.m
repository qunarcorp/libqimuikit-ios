...
#define kSTIMAACollectionCellWidth   ([UIScreen mainScreen].bounds.size.width * 5 / 7)
...
@implementation STIMAACollectionCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _imageView.backgroundColor = [UIColor stimDB_colorWithHex:0xFF9800];
        [_descInfoView addSubview:_imageView];
        
        UIImageView *iconView = [[UIImageView alloc] initWithFrame:CGRectMake(4, 4, 32, 32)];
        iconView.image = [UIImage qimIconWithInfo:[STIMIconInfo iconInfoWithText:@"\U0000f0e4" size:28 color:[UIColor stimDB_colorWithHex:0xFFFFFF alpha:1.0]]];
        ...
        _person_numStrLabel.textColor = [UIColor stimDB_colorWithHex:0x9E9E9E];
        ...
        _totalMoneyLabel.textColor = [UIColor stimDB_colorWithHex:0x9E9E9E];
        ...
        _activityTypeLabel.textColor = [UIColor stimDB_colorWithHex:0x9E9E9E];

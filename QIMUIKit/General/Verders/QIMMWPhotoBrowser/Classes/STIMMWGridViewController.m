...
@interface STIMMWGridViewController () {
...
@implementation STIMMWGridViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.collectionView registerClass:[STIMMWGridCell class] forCellWithReuseIdentifier:@"GridCell"];
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    if (visibleCells) {
        for (STIMMWGridCell *cell in visibleCells) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    STIMMWGridCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"GridCell" forIndexPath:indexPath];
    if (!cell) {
        cell = [[STIMMWGridCell alloc] init];
    }
    id <STIMMWPhoto> photo = [_browser thumbPhotoAtIndex:indexPath.row];
    cell.photo = photo;
...
- (void)collectionView:(UICollectionView *)collectionView didEndDisplayingCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    [((STIMMWGridCell *)cell).photo cancelAnyLoading];
}

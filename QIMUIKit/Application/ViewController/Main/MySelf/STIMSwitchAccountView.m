...
static NSString *cellId = @"STIMSwitchAccountViewCellId";
@interface STIMSwitchAccountView () <UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation STIMSwitchAccountView
...
//    [iconView setImage:addBtn ? [UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"Card_AddIcon"] : [[STIMKit sharedInstance] getUserHeaderImageByUserId:userFullJid]];
    if (!addBtn) {
        [iconView stimDB_setImageWithJid:userFullJid];
    } else {
        [iconView setImage:[UIImage stimDB_imageNamedFromSTIMUIKitBundle:@"Card_AddIcon"]];
    }

...
- (void)onDoneClick{
    if (_textView.text.length > 0) {
        ...
        UIAlertView * alertView = [[UIAlertView alloc] initWithTitle:[NSBundle qim_localizedStringForKey:@"common_prompt"] message:@"您并没有写下任何东西~" delegate:nil cancelButtonTitle:@"俺 know~" otherButtonTitles:nil, nil];
        [alertView show];
    }
}

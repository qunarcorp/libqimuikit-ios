...
@interface STIMModifyRemarkViewController ()<UITextFieldDelegate>
{
...
@implementation STIMModifyRemarkViewController
...
- (void)onDoneBtnClick{
    [[STIMKit sharedInstance] updateUserMarkupNameWithUserId:self.jid WithMarkupName:_inputView.text];
